 ...
 * name, balance, and branch. display account detail for a particular accounts. display total money 
 * deposited in bank. o allow deposit and  withdrawal in an account. for saving account opening 
 * balance and minimum balance must be 5000. for current account opening balance and minimum balance 
 * must be 1000. can not withdraw the amount from the account that makes balance less than the minimum balance. 
 */
